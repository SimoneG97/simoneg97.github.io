...
### <div class="text-sm lg:text-xl font-mono font-bold mb-4 mt-4 divider"><svg viewBox="0 0 48 48" style="height: 180px"><use href="#python"></use></svg>Production plan optimizer</div>
...
I chose to approach this problem by modeling it as a Mixed Integer Linear Program (MILP) and create a library of the most common constraints asked by customers that could also be in part customized.
A very helpful library that helped my development process is <a class="link" target="_blank" rel="noopener noreferrer" href="https://developers.google.com/optimization">Google OR-Tools</a>, check it out.
...
### <div class="text-sm lg:text-xl font-mono font-bold mb-4 mt-4 divider"><svg class="themed-svg" viewBox="0 0 48 48" style="height: 180px"><use href="#python"></use></svg>Production execution optimizer</div>
...
### <div class="text-sm lg:text-xl font-mono font-bold mb-4 mt-4 divider"><svg class="themed-svg" viewBox="0 0 48 48" style="height: 180px"><use href="#python"></use></svg><svg viewBox="0 0 30 30" style="height: 180px"><use href="#javascript"></use></svg>IIoT integration and custom connector</div>
...
### <div class="text-sm lg:text-xl font-mono font-bold mb-4 mt-4 divider"><svg class="themed-svg" viewBox="0 -10 176 96" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="height: 130px"><use href="#coding"></use></svg>Smaller developments and honorable mentions</div>
<svg viewBox="0 0 48 48" style="display: inline-block; height: 25px"><use href="#csharp"></use></svg> Sporadic main project C# bugfixing

<svg viewBox="0 0 48 48" style="display: inline-block; height: 25px"><use href="#python"></use></svg> Python CLI tool used to compare MSSQL databases schemas to check for anomalies / customizations when the standardization of the product was in progress.

<svg viewBox="0 0 48 48" style="display: inline-block; height: 25px"><use href="#rust"></use></svg>  Rust CLI tool that calls multiple APIs to create a list of IIoT devices and its respective monitored variables and export it as a CSV.

<svg viewBox="0 0 48 48" style="display: inline-block; height: 25px"><use href="#rust"></use></svg>  Rust Server for testing purposes which had 2 endpoints, the first one that worked as an "echo" by returning the body that was sent (with the same mimetype) and the second one which simulated a 500 Internal Server Error.
